...
import { uploadToArweave, uploadMetadataToArweave, uploadBatchToArweave, BatchUploadItem, mutateNFTMetadata, loadUploadProgress, clearUploadProgress, preFundIrysForBatch } from "@/integrations/arweave/legacyClient";
import { isDevnet, pinFile, pinFiles, pinJson } from "@/integrations/pinata/client";
import { prepareDevnetManifest } from "@/lib/metadataUpload";
import { debugUpload, debugUri } from "@/lib/deployDebug";
...
export default function LaunchpadCreate() {
    ...
    const handleConfirmOnChainDeploy = async () => {
        ...
        try {
            ...
            // Vanity "…L3AP" branding removed — tester feedback: not needed,
            // adds 30-120s to every deploy and frequently times out.
            // Collection now deploys with a plain generated address.
            const vanitySecret: string | undefined = undefined;
            const vanityPublic: string | undefined = undefined;
